(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".items__slider")) new core(".items__slider", {
            ...
            if (document.querySelector(".big__slider")) new core(".big__slider", {
            ...
            if (document.querySelector(".also__buy-slider")) new core(".also__buy-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        document.querySelectorAll(".nav__list-item").forEach((n => n.addEventListener("click", (() => {
